...
<body>
    ...
    <main>
        <section class="main-left">
            ...
            <div class="info-box" id="fique-por-dentro">
                ...
                <div class="social-media">
                    <a href="https://web.facebook.com/search/top?q=papo%20de%20responsa%20rs" target="_blank"><img src="imgs/facebook.png" alt="facebook"></a>
                    <a href="https://www.instagram.com/papoderesponsarsoficial/" target="_blank"><img src="imgs/instagram.png" alt="instagram"></a>
                    <a href="https://x.com/policiacivilrs" target="_blank"><img src="imgs/twitter.png" alt="twitter"></a>
                </div>
            </div>
        </section>
        <section class="main-sidebar">
            ...
            <div class="sidebar-boxes">
                <a href="https://www.pc.rs.gov.br/inicial" target="_blank"><img src="imgs/policia_civil2.png" alt=""></a>
            </div>
     
            
            <div class="sidebar-boxes">
                <a href="https://institutoculturalfloresta.org.br" target="_blank"><img src="imgs/ics.png" alt=""></a>
            </div>
            <div class="sidebar-boxes">
                <a href="https://ssp.rs.gov.br/inicial" target="_blank"><img src="imgs/ssp.png" alt=""></a>
            </div>
        </section>
    </main>
    <footer id="contato">
    ...
    <div class="icon-container">
        <a href="https://wa.me/5551985955886" target="_blank"><img src="imgs/whats.png" alt="Ícone" class="icon"></a>
